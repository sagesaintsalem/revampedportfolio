    ...
    return(
        <div className="about" accessKey="3">
            ...
            <p className='flex flex-row p-6 lg:text-2xl md:text-xl sm:text-lg'>
                        ...
                        <div className="bg-green-500/30 dark:bg-green-300/40 text-black p-6 rounded-2xl ">
                        <p className='font-bold border-b border-black text-xl p-2'>Stack</p>
                            <ul className="grid grid-cols-2 grid-rows-8 justify-around gap-3 p-6">
                            <li >Javascript</li>
                            <li >Python</li>
                            <li >Java</li>
                            <li>C++</li>
                            ...
                            <ul className="grid grid-cols-2 grid-rows-4 justify-around gap-3 p-6">
                                <li >French</li>
                                <li >Teaching</li>
